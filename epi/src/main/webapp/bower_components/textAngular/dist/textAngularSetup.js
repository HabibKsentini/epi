...
.value('taTranslations', {
	...
	quote: {
		tooltip: 'Quote/unquote selection ou paragraphe'
	},
	undo: {
		tooltip: 'Annuler'
	},
	...
	insertImage: {
		dialogPrompt: 'Ins\u00e9rer une image',
		tooltip: 'Ins\u00e9rer une image',
		hotkey: 'the - possibly language dependent hotkey ... for some future implementation'
	},
	insertVideo: {
		tooltip: 'Ins\u00e9rer\/modifier une vid\u00e9o',
		dialogPrompt: "S'il vous plaît entrer une URL YouTube"
	},
	insertLink: {
		tooltip: 'Ins\u00e9rer un lien',
		dialogPrompt: "Ins\u00e9rer un lien"
	},
	editLink: {
		reLinkButton: {
			tooltip: "Remplacer le lien"
		},
		unLinkButton: {
			tooltip: "Enlever le lien"
		},
		targetToggle: {
			buttontext: "Ouvrir dans une nouvelle fenetre"
		}
	},
	wordcount: {
		tooltip: 'Afficher le nombre de mots'
	},
		charcount: {
		tooltip: 'Afficher le nombre de caractères'
	}
})
...
.run(['taRegisterTool', '$window', 'taTranslations', 'taSelection', 'taToolFunctions', '$sanitize', 'taOptions', function(taRegisterTool, $window, taTranslations, taSelection, taToolFunctions, $sanitize, taOptions){
	...
	taRegisterTool('wordcount', {
		display: '<div id="toolbarWC" style="display:block; min-width:100px;">Mots: <span ng-bind="wordcount"></span></div>',
		disabled: true,
		wordcount: 0,
	...
	taRegisterTool('charcount', {
		display: '<div id="toolbarCC" style="display:block; min-width:120px;"> Caractères: <span ng-bind="charcount"></span></div>',
		disabled: true,
		charcount: 0,
		activeState: function(){ // this fires on keyup
			var textElement = this.$editor().displayElements.text;
